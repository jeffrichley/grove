...
from grove.core.models import ManifestState, PackManifest, ProjectProfile, ToolHookSpec
...
def apply_tool_hooks(
    ...
    *,
    ...
    """Render and apply tool hooks contributed by installed packs.
    ...
    Raises:
        ValueError: A hook contribution is invalid or references missing pack data.
